...
use frontend\modules\forms\models\FormSearch;
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                        [
                                'allow' => true,
                                'actions' => ['index','view','create','update','delete','submits'],
                                'roles' => ['manageUsers'],
                        ],
                ],
            ],
...
//		$model = $modelName::findAll();
		...
		return $this->render('submits', [
			'dataProvider' => $dataProvider,
			'formName' => Form::findOne($id)->name
		]);
	}
