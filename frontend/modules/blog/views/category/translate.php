...
/* @var $source frontend\modules\blog\models\BlogCategory */
/* @var $target frontend\modules\blog\models\BlogCategory */

?>

<div class="trans_wrap" >
	<h1><?= Yii::t('blog', 'CATEGORY_TRANSLATION'); ?></h1>
	...
	<div class="view_draft"><?= Html::a(
		...
		['/blog/category/front-view', 'id' => $target->id],
		[
	...
	<div class="row">
		...
		<div class="col-md-6 target_trans_wrap" id="trans_target" data-id="<?= $target->id ?>" data-url="/blog/category/save-translation">
