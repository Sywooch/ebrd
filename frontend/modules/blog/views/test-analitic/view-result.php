...
$this->title = Yii::t('blog', 'TEST_ANALYTIC_RESULTS');
...
<div class="test admin-test">
	...
	<div id="test_analytic_skill" class="test__container">
		...
		<div class="test__title">
			...
			<div id="test_item_1" class="test-item <?php if($testresult->isCorrectFirstAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-1">
					...
					<div class="test-item__answer">
						...
						<div class="test-item__answer-container flex flex__jcfe">
							<label class="test-item__answer-item">
								<input type="radio" name="radio1" value="A" disabled="true"
									<?php if($testresult->first_answer == 'A'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio1" value="B" disabled="true"
									<?php if($testresult->first_answer == 'B'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio1" value="C" disabled="true"
									<?php if($testresult->first_answer == 'C'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio1" value="D" disabled="true"
									<?php if($testresult->first_answer == 'D'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio1" value="E" disabled="true"
									<?php if($testresult->first_answer == 'E'){
											echo 'checked="true"';
										}
								?>>
		...
		<div id="test_item_2" class="test-item <?php if($testresult->isCorrectSecondAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-2">
				...
				<div class="test-item__content">
					...
					<div class="test-item__answer">
						...
						<div class="test-item__answer-container flex flex__jcfe">
							<label class="test-item__answer-item">
								<input type="radio" name="radio2" value="A" disabled="true"
									<?php if($testresult->second_answer == 'A'){
											echo 'checked="true"';
										}
									?>>
								<span class="test-item__answer-item-text">A</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio2" disabled="true" value="B"
									<?php if($testresult->second_answer == 'B'){
											echo 'checked="true"';
										}
									?>>
								<span class="test-item__answer-item-text">B</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio2" value="C" disabled="true"
									<?php if($testresult->second_answer == 'C'){
											echo 'checked="true"';
										}
									?>>
								<span class="test-item__answer-item-text">C</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio2" value="D" disabled="true"
									<?php if($testresult->second_answer == 'D'){
											echo 'checked="true"';
										}
									?>>
								<span class="test-item__answer-item-text">D</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio2" value="E" disabled="true"
									<?php if($testresult->second_answer == 'E'){
											echo 'checked="true"';
										}
									?>>
								<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_3" class="test-item <?php if($testresult->isCorrectThirdAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-3">
				...
				<div class="test-item__content">
					...
					<div class="test-item__answer">
						...
						<div class="test-item__answer-container flex flex__jcfe">
							<label class="test-item__answer-item">
								<input type="radio" name="radio3" value="A" disabled="true"
									<?php if($testresult->third_answer == 'A'){
											echo 'checked="true"';
										}
								?>>
								<span class="test-item__answer-item-text">A</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio3" value="B" disabled="true"
									<?php if($testresult->third_answer == 'B'){
											echo 'checked="true"';
										}
								?>>
								<span class="test-item__answer-item-text">B</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio3" value="C" disabled="true"
									<?php if($testresult->third_answer == 'C'){
											echo 'checked="true"';
										}
								?>>
								<span class="test-item__answer-item-text">C</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio3" value="D" disabled="true"
									<?php if($testresult->third_answer == 'D'){
											echo 'checked="true"';
										}
								?>>
								<span class="test-item__answer-item-text">D</span>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio3" value="E" disabled="true"
									<?php if($testresult->third_answer == 'E'){
											echo 'checked="true"';
										}
								?>>
								<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_4" class="test-item <?php if($testresult->isCorrectFourthAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-4">
				...
				<div class="test-item__content">
					...
					<div class="test-item__answer flex flex__fdc">
						<div class="test-item__answer-container">
							<label class="test-item__answer-item">
								<input type="radio" name="radio4" value="A" disabled="true"
									<?php if($testresult->fourth_answer == 'A'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio4" value="B" disabled="true"
									<?php if($testresult->fourth_answer == 'B'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio4" value="C" disabled="true"
									<?php if($testresult->fourth_answer == 'C'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio4" value="D" disabled="true"
									<?php if($testresult->fourth_answer == 'D'){
											echo 'checked="true"';
										}
								?>>
							...
							<label class="test-item__answer-item">
								<input type="radio" name="radio4" value="E" disabled="true"
									<?php if($testresult->fourth_answer == 'E'){
											echo 'checked="true"';
										}
								?>>
		...
		<div id="test_item_5" class="test-item <?php if($testresult->isCorrectFifthAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-5">
									...
									<div class="test-item__answer">
										...
										<div class="test-item__answer-container flex flex__fdc ">
											<div class="flex flex__aic text">
												<label class="test-item__answer-item">
													<input type="radio" name="radio5" value="A" disabled="true"
													<?php if($testresult->fifth_answer == 'A'){
											echo 'checked="true"';
														}
													?>>
													<span class="test-item__answer-item-text">A</span>
											...
											<div class="flex flex__aic text">
												<label class="test-item__answer-item">
													<input type="radio" name="radio5" value="B" disabled="true"
													<?php if($testresult->fifth_answer == 'B'){
															echo 'checked="true"';
														}
													?>>
													<span class="test-item__answer-item-text">B</span>
											...
											<div class="flex flex__aic text">
												<label class="test-item__answer-item">
													<input type="radio" name="radio5" value="C" disabled="true"
													<?php if($testresult->fifth_answer == 'C'){
															echo 'checked="true"';
														}
													?>>
													<span class="test-item__answer-item-text">C</span>
											...
											<div class="flex flex__aic text">
												<label class="test-item__answer-item">
													<input type="radio" name="radio5" value="D" disabled="true"
													<?php if($testresult->fifth_answer == 'D'){
															echo 'checked="true"';
														}
													?>>
													<span class="test-item__answer-item-text">D</span>
											...
											<div class="flex flex__aic text">
												<label class="test-item__answer-item">
													<input type="radio" name="radio5" value="E" disabled="true"
													<?php if($testresult->fifth_answer == 'E'){
															echo 'checked="true"';
														}
													?>>
													<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_6" class="test-item <?php if($testresult->isCorrectSixthAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-6">
							...
							<div class="test-item__answer flex flex__fdc">
								...
								<div class="test-item__answer-container">
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio6" value="A" disabled="true"
											<?php if($testresult->sixth_answer == 'A'){
															echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">A</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio6" value="B" disabled="true"
											<?php if($testresult->sixth_answer == 'B'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">B</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio6" value="C" disabled="true"
											<?php if($testresult->sixth_answer == 'C'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">C</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio6" value="D" disabled="true"
											<?php if($testresult->sixth_answer == 'D'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">D</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio6" value="E" disabled="true"
											<?php if($testresult->sixth_answer == 'E'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_7" class="test-item <?php if($testresult->isCorrectSeventhAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-7">
				<!-- test-item-active -->
				<div class="test-item__progress">
						...
						<div class="test-item__question flex__fdc flex__jcc">
							...
							<div class="test-item__answer flex flex__fdc">
								...
								<div class="test-item__answer-container">
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio7" value="A" disabled="true"
											<?php if($testresult->seventh_answer == 'A'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">A</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio7" value="B" disabled="true"
											<?php if($testresult->seventh_answer == 'B'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">B</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio7" value="C" disabled="true"
											<?php if($testresult->seventh_answer == 'C'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">C</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio7" value="D" disabled="true"
											<?php if($testresult->seventh_answer == 'D'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">D</span>
									...
									<div class="flex flex__fdc flex__aic">
										<label class="test-item__answer-item">
											<input type="radio" name="radio7" value="E" disabled="true"
											<?php if($testresult->seventh_answer == 'E'){
													echo 'checked="true"';
												}
											?>>
											<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_8" class="test-item <?php if($testresult->isCorrectEighthAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-8">
				<div class="test-item__progress">
					...
					<div class="flex flex__fdc">
						...
						<div class="test-item__answer flex flex__fdc">
							...
							<div class="test-item__answer-container">
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio8" value="A" disabled="true"
										<?php if($testresult->eighth_answer == 'A'){
													echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">A</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio8" value="B" disabled="true"
										<?php if($testresult->eighth_answer == 'B'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">B</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio8" value="C" disabled="true"
										<?php if($testresult->eighth_answer == 'C'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">C</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio8" value="D" disabled="true"
										<?php if($testresult->eighth_answer == 'D'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">D</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio8" value="E" disabled="true"
										<?php if($testresult->eighth_answer == 'E'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">E</span>
		...
		<div id="test_item_9" class="test-item <?php if($testresult->isCorrectNinthAnswer()) {echo 'test-item__correct';} else { echo 'test-item__incorrect';} ?> test-item__question-9">
				<div class="test-item__progress">
					...
					<div class="flex flex__fdc">
						...
						<div class="test-item__answer flex flex__fdc">
							...
							<div class="test-item__answer-container">
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio9" value="A" disabled="true"
										<?php if($testresult->ninth_answer == 'A'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">A</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio9" value="B" disabled="true"
										<?php if($testresult->ninth_answer == 'B'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">B</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio9" value="C" disabled="true"
										<?php if($testresult->ninth_answer == 'C'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">C</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio9" value="D" disabled="true"
										<?php if($testresult->ninth_answer == 'D'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">D</span>
								...
								<div class="flex flex__fdc flex__aic">
									<label class="test-item__answer-item">
										<input type="radio" name="radio9" value="E" disabled="true"
										<?php if($testresult->ninth_answer == 'E'){
												echo 'checked="true"';
											}
										?>>
										<span class="test-item__answer-item-text">E</span>
		...
		<div class="flex flex__jcsa">
			<a class="button" href="test-result?userid=<?=$userid?>" class="btn btn-default"><?= Yii::t('blog', 'TEST_VIEW_TEST_MARK') ?></a>
			<?php
				if(Yii::$app->user->can('editItem')) {
					echo '<a href="test" class="button">'.Yii::t('blog', 'TEST_COMPLETE_TEST_AGAIN').'</a>';
					echo '<a href="admin-view-result" class="button">'.Yii::t('blog', 'TEST_VIEW_ALL_RESULTS').'</a>';
				}
			?>
		</div>
