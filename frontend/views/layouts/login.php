...
<head>
	...
	<meta property="og:title" content="<?= Html::encode($this->title) .' ‐ '. Yii::$app->name ?>" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="<?= $url = (isset($_SERVER['HTTPS']) ? "https" : "http") . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" />
	<meta property="og:image:width" content="250" />
	<meta property="og:image:height" content="250" />
	<meta property="fb:app_id" content="349526765459603" />
	<meta property="og:site_name" content="<?= Yii::t('settings', 'SAF') ?>" />
    <?php $this->head() ?>
	<!-- Google Tag Manager -->
